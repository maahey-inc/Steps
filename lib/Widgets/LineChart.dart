...
class _LineChartSample2State extends State<LineChartSample2> {
  ...
  LineChartData mainData() {
    final List<double> yValues = [
      //  Provider.of<Homeprovider>(context, listen: false).saturdaySteps,
      //   Provider.of<Homeprovider>(context, listen: false).sundaySteps,
      //  Provider.of<Homeprovider>(context, listen: false).mondaySteps,
      //   Provider.of<Homeprovider>(context, listen: false).tuesdaySteps,
      //  Provider.of<Homeprovider>(context, listen: false).wednesdaySteps,
      //   Provider.of<Homeprovider>(context, listen: false).thursdaySteps,
      //   Provider.of<Homeprovider>(context, listen: false).fridaySteps,
         widget.saturdaySteps ?? 0,
      widget.sundaySteps ?? 0,
      widget.mondaySteps ?? 0,
      widget.tuesdaySteps ?? 0,
      widget.wednesdaySteps ?? 0,
      widget.thursdaySteps ?? 0,
      widget.fridaySteps ?? 0,
